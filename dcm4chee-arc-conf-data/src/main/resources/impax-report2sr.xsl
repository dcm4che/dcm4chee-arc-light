...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template match="/agfa:DiagnosticRadiologyReport">
    <NativeDicomModel>
      <!--Modality-->
      <DicomAttribute keyword="Modality" tag="00080060" vr="CS"><Value number="1">SR</Value></DicomAttribute>
      <DicomAttribute keyword="ValueType" tag="0040A040" vr="CS"><Value number="1">CONTAINER</Value></DicomAttribute>
      <DicomAttribute keyword="ContinuityOfContent" tag="0040A050" vr="CS"><Value number="1">SEPARATE</Value></DicomAttribute>
