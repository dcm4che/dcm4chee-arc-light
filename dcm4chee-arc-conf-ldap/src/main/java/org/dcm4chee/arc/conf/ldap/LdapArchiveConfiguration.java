...
class LdapArchiveConfiguration extends LdapDicomConfigurationExtension {
    ...
    protected void storeTo(ConfigurationChanges.ModifiedObject ldapObj, Device device, Attributes attrs) {
        ...
        LdapUtils.storeNotEmpty(ldapObj, attrs, "dcmRejectExpiredStudiesSchedule", ext.getRejectExpiredStudiesSchedules());
        ...
        LdapUtils.storeNotDef(ldapObj, attrs, "dcmStoreUpdateDBMinRetryDelay", ext.getStoreUpdateDBMinRetryDelay(), 500);
        ...
        LdapUtils.storeNotNullOrDef(ldapObj, attrs, "dcmDefaultWorklistLabel", ext.getDefaultWorklistLabel(), null);
    ...
    protected void loadFrom(Device device, Attributes attrs) throws NamingException {
        ...
        ext.setDefaultWorklistLabel(LdapUtils.stringValue(attrs.get("dcmDefaultWorklistLabel"), null));
    ...
    protected void storeDiffs(ConfigurationChanges.ModifiedObject ldapObj, Device prev, Device device, List<ModificationItem> mods) {
        ...
        LdapUtils.storeDiffObject(ldapObj, mods, "dcmDefaultWorklistLabel",
                aa.getDefaultWorklistLabel(), bb.getDefaultWorklistLabel(), null);
    ...
    protected void storeTo(ConfigurationChanges.ModifiedObject ldapObj, ApplicationEntity ae, Attributes attrs) {
        ...
        LdapUtils.storeNotNullOrDef(ldapObj, attrs, "dcmDefaultWorklistLabel",
                ext.getDefaultWorklistLabel(), null);
        LdapUtils.storeNotEmpty(ldapObj, attrs, "dcmUPSEventSCU", ext.getUPSEventSCUs());
