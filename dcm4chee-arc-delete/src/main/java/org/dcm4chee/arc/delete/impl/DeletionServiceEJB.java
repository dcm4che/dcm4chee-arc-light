...
public class DeletionServiceEJB {
    ...
    public int deleteStudy(StudyDeleteContext ctx, int limit, Location.Status status) {
        ...
        if (!locations.isEmpty()) {
            ...
            Collection<Instance> insts = removeOrMarkToDelete(locations, limit, status);
    ...
    private boolean deleteObjectsOfStudy(Study study, StorageDescriptor desc) {
        ...
        Collection<Instance> insts = removeOrMarkToDelete(locations, Integer.MAX_VALUE, Location.Status.TO_DELETE);
    ...
    private int deleteRejectedInstancesOrRejectionNotes(String queryName, Code rejectionCode, Date before, int limit) {
        ...
        if (!locations.isEmpty()) {
            ...
            Collection<Instance> insts = removeOrMarkToDelete(locations, limit, Location.Status.TO_DELETE);
    ...
    private Collection<Instance> removeOrMarkToDelete(List<Location> locations, int limit, Location.Status status) {
        ...
        for (Location location : locations) {
            ...
            storeEjb.removeOrMarkToDelete(location, status);
        }
