 ...
 * @since Apr 2016
 */
public class DecompressPixelDataOutput implements StreamingOutput {
    ...
    private void initEncapsulatedPixelData(DicomInputStream dis) throws IOException {
    ...
    private void writeFrameTo(OutputStream out) throws IOException {
    ...
    private void writeTo(SampleModel sm, short[] data, OutputStream out) throws IOException {
        int h = sm.getHeight();
        int w = sm.getWidth();
    ...
    private void writeTo(SampleModel sm, int[] data, OutputStream out) throws IOException {
        int h = sm.getHeight();
        int w = sm.getWidth();
