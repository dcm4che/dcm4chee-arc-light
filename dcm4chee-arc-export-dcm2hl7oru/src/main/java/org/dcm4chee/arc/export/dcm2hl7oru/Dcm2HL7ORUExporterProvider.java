...
@ApplicationScoped
@Named("hl7oru")
public class Dcm2HL7ORUExporterProvider implements ExporterProvider  {
    ...
    public Exporter getExporter(ExporterDescriptor descriptor) {
        return new Dcm2HL7ORUExporter(descriptor, hl7Sender, device, retrieveService, hl7AppCache);
    }
}
