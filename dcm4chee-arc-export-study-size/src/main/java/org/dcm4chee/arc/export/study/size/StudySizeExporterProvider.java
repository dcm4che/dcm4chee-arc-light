...
package org.dcm4chee.arc.export.study.size;
...
@ApplicationScoped
@Named("study-size")
public class StudySizeExporterProvider implements ExporterProvider {
    ...
    public Exporter getExporter(ExporterDescriptor descriptor) {
        return new StudySizeExporter(descriptor, querySizeEJB);
    }
}
