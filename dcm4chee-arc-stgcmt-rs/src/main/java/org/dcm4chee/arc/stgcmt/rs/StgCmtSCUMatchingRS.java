...
public class StgCmtSCUMatchingRS {
    ...
    public Response matchingStudyStorageCommit() {
        return storageCommitMatching("matchingStudyStorageCommit",
    ...
    public Response matchingSeriesStorageCommit() {
        return storageCommitMatching("matchingSeriesStorageCommit",
    ...
    public Response matchingSeriesOfStudyStorageCommit(
        ...
        return storageCommitMatching("matchingSeriesOfStudyStorageCommit",
    ...
    public Response matchingInstancesStorageCommit() {
        return storageCommitMatching("matchingInstancesStorageCommit",
    ...
    public Response matchingInstancesOfStudyStorageCommit(
            @PathParam("StudyInstanceUID") String studyUID) {
        return storageCommitMatching("matchingInstancesOfStudyStorageCommit",
    ...
    public Response matchingInstancesOfSeriesStorageCommit(
        ...
        return storageCommitMatching("matchingInstancesOfSeriesStorageCommit",
            ...
            try (Query query = queryService.createQuery(ctx)) {
                try {
                    ...
                    while (query.hasMoreMatches()) {
                        ...
                        stgCmtSCU.scheduleStorageCommit(aet, externalAET, match, batchID, qrlevel);
                        count++;
                    }
