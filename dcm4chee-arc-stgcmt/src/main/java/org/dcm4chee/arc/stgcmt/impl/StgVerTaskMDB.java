...
public class StgVerTaskMDB implements MessageListener {

    private static final Logger LOG = LoggerFactory.getLogger(StgVerTaskMDB.class);
    ...
    public void onMessage(Message msg) {
        ...
        try {
            Outcome outcome = stgCmtMgr.executeStgVerTask(
                    queueMessage.getStorageVerificationTask(), HttpServletRequestInfo.valueOf(msg));
