...
public class ConditionsTest {
    ...
    public void match() throws Exception {
        ...
        assertTrue(hostname.match("storescu", null, null, empty));
        assertFalse(hostname.match("dcmqrscp", null, null, empty));
        assertFalse(hostname.match("dcmqrscp", null, null, empty));
        Conditions nothostname = new Conditions("SendingHostname!=storescu");
        assertFalse(nothostname.match("storescu", null, null, empty));
        assertTrue(nothostname.match("dcmqrscp", null, null, empty));
        assertTrue(nothostname.match(null, null, null, empty));
        Conditions sending = new Conditions("SendingApplicationEntityTitle=STORESCU");
        assertTrue(sending.match(null, "STORESCU", null, empty));
        assertFalse(sending.match(null, "DCMQRSCP", null, empty));
        assertFalse(sending.match(null, null, null, empty));
        Conditions notsending = new Conditions("SendingApplicationEntityTitle!=STORESCU");
        assertFalse(notsending.match(null, "STORESCU", null, empty));
        assertTrue(notsending.match(null, "DCMQRSCP", null, empty));
        assertTrue(notsending.match(null, null, null, empty));
        Conditions receiving = new Conditions("ReceivingApplicationEntityTitle=DCM4CHEE");
        assertTrue(receiving.match(null, null, "DCM4CHEE", empty));
        assertFalse(receiving.match(null, null, "DCMQRSCP", empty));
        assertFalse(receiving.match(null, null, null, empty));
        Conditions notreceiving = new Conditions("ReceivingApplicationEntityTitle!=DCM4CHEE");
        assertFalse(notreceiving.match(null, null, "DCM4CHEE", empty));
        assertTrue(notreceiving.match(null, null, "DCMQRSCP", empty));
