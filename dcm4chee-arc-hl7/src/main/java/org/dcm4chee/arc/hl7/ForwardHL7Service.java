...
class ForwardHL7Service extends AbstractHL7Service {

    public ForwardHL7Service() {
        super();
    }

    @Override
    protected void process(HL7Application hl7App, Socket s, UnparsedHL7Message msg) throws Exception {
        forwardHL7(hl7App, s, msg);
    }

    private void forwardHL7(HL7Application hl7App, Socket s, UnparsedHL7Message msg)
