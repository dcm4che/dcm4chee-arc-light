...
class ArchiveDeviceFactory {
    ...
    static final String[] IMAGE_CUIDS = {
            ...
            UID.CTImageStorageForProcessing,
            UID.EnhancedCTImageStorageForProcessing,
            UID.LegacyConvertedEnhancedCTImageStorageForProcessing,
   ...
   static final QueryRetrieveView IOCM_DISABLED_VIEW =
    ...
    static final String STORAGE_URI = "${jboss.server.storage.url}/fs1/";
    static final String NEARLINE_STORAGE_ID = "nearline";
    static final String NEARLINE_STORAGE_URI = "${jboss.server.storage.url}/nearline/";
    ...
    static final String METADATA_STORAGE_URI = "${jboss.server.storage.url}/metadata/";
    ...
    static final String SERIES_METADATA_STORAGE_URI = "${jboss.server.storage.url}/series-metadata/";
    ...
    static final String WADO_JPEG_STORAGE_URI = "${jboss.server.storage.url}/wado/";
    ...
    static final String WADO_JSON_STORAGE_URI = "${jboss.server.storage.url}/wado/";
    static final String QIDO_JSON_STORAGE_URI = "${jboss.server.storage.url}/qido/";
