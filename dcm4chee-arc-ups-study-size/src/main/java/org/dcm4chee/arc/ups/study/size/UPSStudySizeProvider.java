...
package org.dcm4chee.arc.ups.study.size;
...
@ApplicationScoped
@Named("studySize")
public class UPSStudySizeProvider implements UPSProcessorProvider  {
    ...
    public UPSProcessor getUPSProcessor(UPSProcessingRule rule) {
        return new UPSStudySize(rule, upsService, querySizeEJB);
    }
}
