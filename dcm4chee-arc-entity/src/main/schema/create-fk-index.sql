...
create index FK_jxfu47kwjk3kkkyrwewjw8a4n on instance (dicomattrs_fk) ;
...
create index FK_5lgndn3gn7iug3kuewiy9q124 on patient (dicomattrs_fk) ;
...
create index FK_bdj2kuutidekc2en6dckev7l6 on series (dicomattrs_fk) ;
...
create index FK_5w0oynbw061mwu1rr9mrb6kj4 on study (dicomattrs_fk) ;
