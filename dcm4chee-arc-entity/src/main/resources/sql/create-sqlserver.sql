...
create table export_task (pk bigint identity not null, created_time datetime2 not null, device_name varchar(255) not null, exporter_id varchar(255) not null, modalities varchar(255), num_instances int, scheduled_time datetime2 not null, series_iuid varchar(255) not null, sop_iuid varchar(255) not null, study_iuid varchar(255) not null, updated_time datetime2 not null, version bigint, queue_msg_fk bigint, primary key (pk));
...
create table patient (pk bigint identity not null, created_time datetime2 not null, num_studies int not null, pat_birthdate varchar(255) not null, pat_custom1 varchar(255) not null, pat_custom2 varchar(255) not null, pat_custom3 varchar(255) not null, pat_sex varchar(255) not null, updated_time datetime2 not null, version bigint, dicomattrs_fk bigint not null, merge_fk bigint, patient_id_fk bigint, pat_name_fk bigint, resp_person_fk bigint, primary key (pk));
...
create table queue_msg (pk bigint identity not null, batchID varchar(255), created_time datetime2 not null, device_name varchar(255) not null, error_msg varchar(255), msg_body image not null, msg_id varchar(255) not null, msg_props varchar(4000) not null, num_failures int not null, outcome_msg varchar(255), priority int not null, proc_end_time datetime2, proc_start_time datetime2, queue_name varchar(255) not null, scheduled_time datetime2 not null, msg_status int not null, updated_time datetime2 not null, version bigint, primary key (pk));
create table rel_study_pcode (study_fk bigint not null, pcode_fk bigint not null);
create table retrieve_task (pk bigint identity not null, completed int not null, created_time datetime2 not null, destination_aet varchar(255) not null, error_comment varchar(255), failed int not null, local_aet varchar(255) not null, remaining int not null, remote_aet varchar(255) not null, series_iuid varchar(255), sop_iuid varchar(255), status_code int not null, study_iuid varchar(255) not null, updated_time datetime2 not null, warning int not null, queue_msg_fk bigint not null, primary key (pk));
create table series (pk bigint identity not null, body_part varchar(255) not null, completeness int not null, created_time datetime2 not null, expiration_date varchar(255), ext_retrieve_aet varchar(255), failed_retrieves int not null, inst_purge_state int not null, inst_purge_time datetime2, institution varchar(255) not null, department varchar(255) not null, laterality varchar(255) not null, metadata_update_time datetime2, modality varchar(255) not null, pps_cuid varchar(255) not null, pps_iuid varchar(255) not null, pps_start_date varchar(255) not null, pps_start_time varchar(255) not null, rejection_state int not null, series_custom1 varchar(255) not null, series_custom2 varchar(255) not null, series_custom3 varchar(255) not null, series_desc varchar(255) not null, series_iuid varchar(255) not null, series_no int, series_size bigint not null, sop_cuid varchar(255) not null, src_aet varchar(255), station_name varchar(255) not null, tsuid varchar(255) not null, updated_time datetime2 not null, version bigint, dicomattrs_fk bigint not null, inst_code_fk bigint, metadata_fk bigint, perf_phys_name_fk bigint, study_fk bigint not null, primary key (pk));
