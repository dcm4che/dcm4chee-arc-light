...
create table retrieve_task (pk bigint identity not null, batch_id varchar(255), completed int not null, created_time datetime2 not null, destination_aet varchar(255) not null, device_name varchar(255) not null, error_comment varchar(255), failed int not null, local_aet varchar(255) not null, queue_name varchar(255) not null, remaining int not null, remote_aet varchar(255) not null, series_iuid varchar(255), sop_iuid varchar(255), status_code int not null, study_iuid varchar(255) not null, updated_time datetime2 not null, warning int not null, queue_msg_fk bigint, primary key (pk));
