...
create table dicomattrs (pk bigint identity not null, attrs image not null, primary key (pk));
...
create table export_task (pk bigint identity not null, batch_id varchar(255), created_time datetime2 not null, device_name varchar(255) not null, exporter_id varchar(255) not null, modalities varchar(255), num_instances int, scheduled_time datetime2, series_iuid varchar(255) not null, sop_iuid varchar(255) not null, study_iuid varchar(255) not null, updated_time datetime2 not null, version bigint, queue_msg_fk bigint, primary key (pk));
...
create table hl7psu_task (pk bigint identity not null, aet varchar(255) not null, created_time datetime2 not null, device_name varchar(255) not null, scheduled_time datetime2, series_iuid varchar(255), study_iuid varchar(255), mpps_fk bigint, primary key (pk));
...
create table issuer (pk bigint identity not null, entity_id varchar(255), entity_uid varchar(255), entity_uid_type varchar(255), primary key (pk));
create table location (pk bigint identity not null, created_time datetime2 not null, digest varchar(255), multi_ref int, object_type int not null, object_size bigint not null, status int not null, storage_id varchar(255) not null, storage_path varchar(255) not null, tsuid varchar(255), instance_fk bigint, uidmap_fk bigint, primary key (pk));
...
create table mpps (pk bigint identity not null, accession_no varchar(255) not null, created_time datetime2 not null, pps_start_date varchar(255) not null, pps_start_time varchar(255) not null, sop_iuid varchar(255) not null, pps_status int not null, study_iuid varchar(255) not null, updated_time datetime2 not null, version bigint, dicomattrs_fk bigint not null, discreason_code_fk bigint, accno_issuer_fk bigint, patient_fk bigint not null, primary key (pk));
create table mwl_item (pk bigint identity not null, accession_no varchar(255) not null, admission_id varchar(255) not null, created_time datetime2 not null, institution varchar(255) not null, department varchar(255) not null, modality varchar(255) not null, req_proc_id varchar(255) not null, sps_id varchar(255) not null, sps_start_date varchar(255) not null, sps_start_time varchar(255) not null, sps_status int not null, study_iuid varchar(255) not null, updated_time datetime2 not null, version bigint, dicomattrs_fk bigint not null, inst_code_fk bigint, dept_code_fk bigint, accno_issuer_fk bigint, admid_issuer_fk bigint, patient_fk bigint not null, perf_phys_name_fk bigint, primary key (pk));
...
create table retrieve_task (pk bigint identity not null, batch_id varchar(255), completed int not null, created_time datetime2 not null, destination_aet varchar(255) not null, device_name varchar(255) not null, error_comment varchar(255), failed int not null, local_aet varchar(255) not null, queue_name varchar(255) not null, remaining int not null, remote_aet varchar(255) not null, scheduled_time datetime2, series_iuid varchar(255), sop_iuid varchar(255), status_code int not null, study_iuid varchar(255) not null, updated_time datetime2 not null, warning int not null, queue_msg_fk bigint, primary key (pk));
create table series (pk bigint identity not null, body_part varchar(255) not null, completeness int not null, compress_failures int not null, compress_params varchar(255), compress_time datetime2, compress_tsuid varchar(255), created_time datetime2 not null, expiration_date varchar(255), expiration_exporter_id varchar(255), expiration_state int not null, ext_retrieve_aet varchar(255), failed_retrieves int not null, stgver_failures int not null, inst_purge_state int not null, inst_purge_time datetime2, institution varchar(255) not null, department varchar(255) not null, laterality varchar(255) not null, metadata_update_time datetime2, metadata_update_failures int not null, modality varchar(255) not null, pps_cuid varchar(255) not null, pps_iuid varchar(255) not null, pps_start_date varchar(255) not null, pps_start_time varchar(255) not null, rejection_state int not null, series_custom1 varchar(255) not null, series_custom2 varchar(255) not null, series_custom3 varchar(255) not null, series_desc varchar(255) not null, series_iuid varchar(255) not null, series_no int, series_size bigint not null, sop_cuid varchar(255) not null, src_aet varchar(255), station_name varchar(255) not null, stgver_time datetime2, tsuid varchar(255) not null, updated_time datetime2 not null, version bigint, dicomattrs_fk bigint not null, inst_code_fk bigint, dept_code_fk bigint, metadata_fk bigint, perf_phys_name_fk bigint, study_fk bigint not null, primary key (pk));
...
create table stgcmt_result (pk bigint identity not null, batch_id varchar(255), created_time datetime2 not null, device_name varchar(255) not null, exporter_id varchar(255), msg_id varchar(255), num_failures int, num_instances int, series_iuid varchar(255), sop_iuid varchar(255), stgcmt_status int not null, study_iuid varchar(255) not null, transaction_uid varchar(255) not null, updated_time datetime2 not null, primary key (pk));
