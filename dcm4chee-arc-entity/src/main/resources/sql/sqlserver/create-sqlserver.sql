...
create unique nonclustered index UKt1uhb1suiiqffhsv9eaopeevs on series_query_attrs (view_id, series_fk) where view_id is not null;
...
create unique nonclustered index UKprn4qt6d42stw0gfi1yce1fap on study_query_attrs (view_id, study_fk) where view_id is not null;
