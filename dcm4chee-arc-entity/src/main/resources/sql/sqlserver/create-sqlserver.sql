...
create table patient_id (pk bigint identity not null, pat_id varchar(255) not null, pat_id_type_code varchar(255), entity_id varchar(255), pat_name varchar(255) not null, entity_uid varchar(255), entity_uid_type varchar(255), version bigint, patient_fk bigint not null, primary key (pk));
