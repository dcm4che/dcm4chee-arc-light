...
create table key_value (pk bigint identity not null, content_type varchar(255) not null, created_time datetime2 not null, key varchar(255) not null, updated_time datetime2 not null, username varchar(255), value varchar(4000) not null, primary key (pk));
...
create table mwl_item (pk bigint identity not null, accession_no varchar(255) not null, accno_entity_id varchar(255), accno_entity_uid varchar(255), accno_entity_uid_type varchar(255), admission_id varchar(255) not null, admid_entity_id varchar(255), admid_entity_uid varchar(255), admid_entity_uid_type varchar(255), created_time datetime2 not null, institution varchar(255) not null, department varchar(255) not null, local_aet varchar(255) not null, modality varchar(255) not null, req_proc_id varchar(255) not null, sps_id varchar(255) not null, sps_start_date varchar(255) not null, sps_start_time varchar(255) not null, sps_status int not null, study_iuid varchar(255) not null, updated_time datetime2 not null, version bigint, dicomattrs_fk bigint not null, inst_code_fk bigint, dept_code_fk bigint, patient_fk bigint not null, perf_phys_name_fk bigint, primary key (pk));
