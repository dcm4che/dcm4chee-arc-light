...
create table content_item (pk bigint identity not null, rel_type varchar(255) not null, text_value nvarchar(255), code_fk bigint, name_fk bigint not null, instance_fk bigint, primary key (pk));
...
alter table series_access_control_id add constraint FKt7uu3btv6pro4wuxspq0pom8y foreign key (series_fk) references series;
...
alter table study_access_control_id add constraint FKluah7q5kdwqidu6uwlrsndd7k foreign key (study_fk) references study;
