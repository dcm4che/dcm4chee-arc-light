create table code (pk bigint identity not null, code_meaning nvarchar(255) not null, code_value varchar(255) not null, code_designator varchar(255) not null, code_version varchar(255) not null, primary key (pk));
create table content_item (pk bigint identity not null, rel_type varchar(255) not null, text_value nvarchar(255) not null, code_fk bigint, name_fk bigint not null, instance_fk bigint, primary key (pk));
create table dicomattrs (pk bigint identity not null, attrs varbinary(255) not null, primary key (pk));
...
create table hl7psu_task (pk bigint identity not null, accession_no nvarchar(255) not null, aet varchar(255) not null, created_time datetime2(6) not null, device_name varchar(255) not null, pps_status smallint check (pps_status between 0 and 2), scheduled_time datetime2(6), series_iuid varchar(255), study_iuid varchar(255), mpps_fk bigint, primary key (pk));
create table ian_task (pk bigint identity not null, calling_aet varchar(255) not null, device_name varchar(255) not null, ian_dests varchar(255) not null, scheduled_time datetime2(6), study_iuid varchar(255), mpps_fk bigint, primary key (pk));
create table id_sequence (name varchar(255) not null, next_value int not null, version bigint, primary key (name));
create table instance (pk bigint identity not null, availability smallint not null check (availability between 0 and 3), sr_complete varchar(255) not null, content_date varchar(255) not null, content_time varchar(255) not null, created_time datetime2(6) not null, ext_retrieve_aet varchar(255) not null, inst_custom1 varchar(255) not null, inst_custom2 varchar(255) not null, inst_custom3 varchar(255) not null, inst_no int, num_frames int, retrieve_aets varchar(255), sop_cuid varchar(255) not null, sop_iuid varchar(255) not null, updated_time datetime2(6) not null, sr_verified varchar(255) not null, version bigint, dicomattrs_fk bigint not null, srcode_fk bigint, series_fk bigint not null, primary key (pk));
create table instance_req (pk bigint identity not null, accession_no nvarchar(255) not null, accno_entity_id varchar(255), accno_entity_uid varchar(255), accno_entity_uid_type varchar(255), req_proc_id nvarchar(255) not null, req_service nvarchar(255) not null, sps_id nvarchar(255) not null, study_iuid varchar(255) not null, req_phys_name_fk bigint, instance_fk bigint, primary key (pk));
create table key_value2 (pk bigint identity not null, content_type varchar(255) not null, created_time datetime2(6) not null, key_name varchar(255) not null, updated_time datetime2(6) not null, username varchar(255), key_value varchar(4000) not null, primary key (pk));
create table location (pk bigint identity not null, created_time datetime2(6) not null, digest varchar(255), multi_ref int, object_type smallint not null check (object_type between 0 and 1), object_size bigint not null, status smallint not null check (status between 0 and 17), storage_id varchar(255) not null, storage_path varchar(255) not null, tsuid varchar(255), uidmap_fk bigint, instance_fk bigint, primary key (pk));
create table metadata (pk bigint identity not null, created_time datetime2(6) not null, digest varchar(255), object_size bigint not null, status smallint not null check (status between 0 and 9), storage_id varchar(255) not null, storage_path varchar(255) not null, primary key (pk));
create table mpps (pk bigint identity not null, accession_no nvarchar(255) not null, accno_entity_id varchar(255), accno_entity_uid varchar(255), accno_entity_uid_type varchar(255), created_time datetime2(6) not null, pps_start_date varchar(255) not null, pps_start_time varchar(255) not null, sop_iuid varchar(255) not null, pps_status smallint not null check (pps_status between 0 and 2), study_iuid varchar(255) not null, updated_time datetime2(6) not null, version bigint, dicomattrs_fk bigint not null, discreason_code_fk bigint, patient_fk bigint not null, primary key (pk));
create table mwl_item (pk bigint identity not null, accession_no nvarchar(255) not null, accno_entity_id varchar(255), accno_entity_uid varchar(255), accno_entity_uid_type varchar(255), admission_id nvarchar(255) not null, admid_entity_id varchar(255), admid_entity_uid varchar(255), admid_entity_uid_type varchar(255), created_time datetime2(6) not null, institution nvarchar(255) not null, department nvarchar(255) not null, modality varchar(255) not null, req_proc_id nvarchar(255) not null, sps_id nvarchar(255) not null, sps_start_date varchar(255) not null, sps_start_time varchar(255) not null, sps_status smallint not null check (sps_status between 0 and 7), study_iuid varchar(255) not null, updated_time datetime2(6) not null, version bigint, worklist_label varchar(255) not null, dicomattrs_fk bigint not null, inst_code_fk bigint, dept_code_fk bigint, patient_fk bigint not null, perf_phys_name_fk bigint, primary key (pk));
create table patient (pk bigint identity not null, created_time datetime2(6) not null, failed_verifications int not null, num_studies int not null, pat_birthdate varchar(255) not null, pat_custom1 varchar(255) not null, pat_custom2 varchar(255) not null, pat_custom3 varchar(255) not null, pat_sex varchar(255) not null, updated_time datetime2(6) not null, verification_status smallint not null check (verification_status between 0 and 4), verification_time datetime2(6), version bigint, dicomattrs_fk bigint not null, merge_fk bigint, pat_name_fk bigint, resp_person_fk bigint, primary key (pk));
...
create table patient_id (pk bigint identity not null, pat_id varchar(255) not null, pat_id_type_code varchar(255), entity_id varchar(255) not null, pat_name varchar(255) not null, entity_uid varchar(255) not null, entity_uid_type varchar(255) not null, version bigint, patient_fk bigint not null, primary key (pk));
create table person_name (pk bigint identity not null, alphabetic_name nvarchar(255), ideographic_name nvarchar(255), phonetic_name nvarchar(255), primary key (pk));
create table rejected_instance (pk bigint identity not null, created_time datetime2(6) not null, series_iuid varchar(255) not null, sop_cuid varchar(255) not null, sop_iuid varchar(255) not null, study_iuid varchar(255) not null, reject_code_fk bigint, primary key (pk));
...
create table series (pk bigint identity not null, access_control_id varchar(255) not null, body_part varchar(255) not null, completeness smallint not null check (completeness between 0 and 2), compress_failures int not null, compress_params varchar(255), compress_time datetime2(6), compress_tsuid varchar(255), created_time datetime2(6) not null, expiration_date varchar(255), expiration_exporter_id varchar(255), expiration_state smallint not null check (expiration_state between 0 and 5), ext_retrieve_aet varchar(255) not null, failed_retrieves int not null, stgver_failures int not null, inst_purge_state smallint not null check (inst_purge_state between 0 and 2), inst_purge_time datetime2(6), institution nvarchar(255) not null, department nvarchar(255) not null, laterality varchar(255) not null, metadata_update_time datetime2(6), metadata_update_failures int not null, metadata_update_load_objects bit not null, modality varchar(255) not null, modified_time datetime2(6) not null, pps_cuid varchar(255) not null, pps_iuid varchar(255) not null, pps_start_date varchar(255) not null, pps_start_time varchar(255) not null, receiving_aet varchar(255), receiving_hl7_app varchar(255), receiving_hl7_facility varchar(255), receiving_pres_addr varchar(255), rejection_state smallint not null check (rejection_state between 0 and 3), sending_aet varchar(255), sending_hl7_app varchar(255), sending_hl7_facility varchar(255), sending_pres_addr varchar(255), series_custom1 varchar(255) not null, series_custom2 varchar(255) not null, series_custom3 varchar(255) not null, series_desc nvarchar(255) not null, series_iuid varchar(255) not null, series_no int, series_size bigint not null, sop_cuid varchar(255) not null, station_name nvarchar(255) not null, stgver_time datetime2(6), tsuid varchar(255) not null, updated_time datetime2(6) not null, version bigint, dicomattrs_fk bigint not null, inst_code_fk bigint, dept_code_fk bigint, metadata_fk bigint, perf_phys_name_fk bigint, study_fk bigint not null, primary key (pk));
create table series_query_attrs (pk bigint identity not null, availability smallint check (availability between 0 and 3), num_instances int, retrieve_aets varchar(255), cuids_in_series varchar(255), view_id varchar(255), series_fk bigint not null, primary key (pk));
create table series_req (pk bigint identity not null, accession_no nvarchar(255) not null, accno_entity_id varchar(255), accno_entity_uid varchar(255), accno_entity_uid_type varchar(255), req_proc_id nvarchar(255) not null, req_service nvarchar(255) not null, sps_id nvarchar(255) not null, study_iuid varchar(255) not null, req_phys_name_fk bigint, series_fk bigint, primary key (pk));
create table soundex_code (pk bigint identity not null, sx_code_value varchar(255) not null, sx_pn_comp_part int not null, sx_pn_comp smallint not null check (sx_pn_comp between 0 and 4), person_name_fk bigint not null, primary key (pk));
create table sps_station_aet (mwl_item_fk bigint not null, station_aet varchar(255));
create table stgcmt_result (pk bigint identity not null, batch_id varchar(255), created_time datetime2(6) not null, device_name varchar(255) not null, exporter_id varchar(255), num_failures int, num_instances int, series_iuid varchar(255), sop_iuid varchar(255), stgcmt_status smallint not null check (stgcmt_status between 0 and 3), study_iuid varchar(255) not null, task_fk bigint, transaction_uid varchar(255) not null, updated_time datetime2(6) not null, primary key (pk));
create table study (pk bigint identity not null, access_control_id varchar(255) not null, access_time datetime2(6) not null, accession_no nvarchar(255) not null, accno_entity_id varchar(255), accno_entity_uid varchar(255), accno_entity_uid_type varchar(255), admission_id nvarchar(255) not null, admid_entity_id varchar(255), admid_entity_uid varchar(255), admid_entity_uid_type varchar(255), completeness smallint not null check (completeness between 0 and 2), created_time datetime2(6) not null, study_deleting bit not null, expiration_date varchar(255), expiration_exporter_id varchar(255), expiration_state smallint not null check (expiration_state between 0 and 5), ext_retrieve_aet varchar(255) not null, failed_retrieves int not null, modified_time datetime2(6) not null, rejection_state smallint not null check (rejection_state between 0 and 3), study_size bigint not null, storage_ids varchar(255), study_custom1 varchar(255) not null, study_custom2 varchar(255) not null, study_custom3 varchar(255) not null, study_date varchar(255) not null, study_desc nvarchar(255) not null, study_id nvarchar(255) not null, study_iuid varchar(255) not null, study_time varchar(255) not null, updated_time datetime2(6) not null, version bigint, dicomattrs_fk bigint not null, patient_fk bigint not null, ref_phys_name_fk bigint, primary key (pk));
create table study_query_attrs (pk bigint identity not null, availability smallint check (availability between 0 and 3), mods_in_study varchar(255), num_instances int, num_series int, retrieve_aets varchar(255), cuids_in_study varchar(4000), view_id varchar(255), study_fk bigint not null, primary key (pk));
...
create unique nonclustered index UKf1l196ykcnh7s2pwo6qnmltw7 on global_subscription (matchkeys_fk) where matchkeys_fk is not null;
create index IDXt0y05h07d9dagn9a4a9s4a5a4 on hl7psu_task (device_name);
create unique nonclustered index UK1t3jge4o2fl1byp3y8ljmkb3m on hl7psu_task (study_iuid, pps_status) where study_iuid is not null and pps_status is not null;
create unique nonclustered index UKpev4urgkk7id2h1ijhv8domjx on hl7psu_task (mpps_fk) where mpps_fk is not null;
create index IDX5shiir23exao1xpy2n5gvasrh on ian_task (device_name);
create unique nonclustered index UKdq88edcjjxh7h92f89y5ueast on ian_task (study_iuid) where study_iuid is not null;
create unique nonclustered index UK1fuh251le2hid2byw90hd1mly on ian_task (mpps_fk) where mpps_fk is not null;
...
create unique nonclustered index UKcqmmps9maltjybl44t4cck404 on instance_req (req_phys_name_fk) where req_phys_name_fk is not null;
...
create unique nonclustered index UK44qwwvs50lgpog2cqmicxgt1f on mwl_item (perf_phys_name_fk) where perf_phys_name_fk is not null;
...
create unique nonclustered index UKrj42ffdtimnrcwmqqlvj24gi2 on patient (pat_name_fk) where pat_name_fk is not null;
create unique nonclustered index UK56r2g5ggptqgcvb3hl11adke2 on patient (resp_person_fk) where resp_person_fk is not null;
...
create unique nonclustered index UKpu4p7k1o9hleuk9rmxvw2ybj6 on series (metadata_fk) where metadata_fk is not null;
create unique nonclustered index UK5n4bxxb2xa7bvvq26ao7wihky on series (perf_phys_name_fk) where perf_phys_name_fk is not null;
create unique nonclustered index UKt1uhb1suiiqffhsv9eaopeevs on series_query_attrs (view_id, series_fk) where view_id is not null and series_fk is not null;
...
create unique nonclustered index UKbcn0jtvurqutw865pwp34pejb on series_req (req_phys_name_fk) where req_phys_name_fk is not null;
...
create unique nonclustered index UK49eet5qgcsb32ktsqrf1mj3x2 on study (ref_phys_name_fk) where ref_phys_name_fk is not null;
create unique nonclustered index UKprn4qt6d42stw0gfi1yce1fap on study_query_attrs (view_id, study_fk) where view_id is not null and study_fk is not null;
...
create unique nonclustered index UKkocdb2pxx2fymu1modhneb4xm on ups_req (req_phys_name_fk) where req_phys_name_fk is not null;
create index IDX5btv5autls384ulwues8lym4p on verify_observer (verify_datetime);
create unique nonclustered index UK105wt9hglqsmtnoxgma9x18vj on verify_observer (observer_name_fk) where observer_name_fk is not null;
