...
update study set study_deleting = 0;

-- part 2: shall be applied on stopped archive before starting 5.32
update instance set ext_retrieve_aet = '*' where ext_retrieve_aet is null;
update series set ext_retrieve_aet = '*' where ext_retrieve_aet is null;
update study set study_deleting = 0 where study_deleting is null;

-- part 3: can be applied on already running archive 5.32
alter table instance alter column ext_retrieve_aet varchar(255) not null;
alter table series alter column ext_retrieve_aet varchar(255) not null;
alter table study alter column study_deleting bit not null;