...
create table global_subscription (
    ...
    subscriber_aet varchar(64) not null,
    matchkeys_fk numeric(18,0),
    primary key (pk));

create table rel_ups_perf_code (
    ups_fk numeric(18,0) not null,
    perf_code_fk numeric(18,0) not null);
...
create table ups (
    ...
    expected_end_date_time varchar(64) not null,
    input_readiness_state integer not null,
    performer_aet varchar(255),
    ups_state integer not null,
    replaced_iuid varchar(64) not null,
    expiration_date_time varchar(64) not null,
    start_date_time varchar(64) not null,
    transaction_iuid varchar(255),
    updated_time timestamp not null,
    ups_iuid varchar(64) not null,
    ups_label varchar(64) not null,
    ups_priority integer not null,
    version numeric(18,0),
    worklist_label varchar(64) not null,
    dicomattrs_fk numeric(18,0) not null,
    admission_issuer_fk numeric(18,0),
    patient_fk numeric(18,0) not null,
    station_class_fk numeric(18,0),
    station_location_fk numeric(18,0),
    station_name_fk numeric(18,0),
    ups_code_fk numeric(18,0),
    primary key (pk));

create table ups_req (
    pk numeric(18,0) not null,
    accession_no varchar(64) not null,
    req_proc_id varchar(64) not null,
    req_service varchar(64) not null,
    study_iuid varchar(64) not null,
    accno_issuer_fk numeric(18,0),
    req_phys_name_fk numeric(18,0),
    ups_fk numeric(18,0),
    primary key (pk));
