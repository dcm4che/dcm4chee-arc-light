alter table study add access_time datetime2, scattered_storage bit;
update study set access_time = updated_time, scattered_storage = false, access_control_id = '*';
alter table study alter column access_time datetime2 not null;
alter table study alter column scattered_storage bit not null;
alter table study alter column access_control_id varchar(255) not null;
...
alter table study alter column failed_retrieves integer not null;
