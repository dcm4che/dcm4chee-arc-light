...
create table patient (pk numeric(18,0) not null, created_time timestamp not null, num_studies integer not null, pat_birthdate varchar(255) not null, pat_custom1 varchar(255) not null, pat_custom2 varchar(255) not null, pat_custom3 varchar(255) not null, pat_sex varchar(255) not null, updated_time timestamp not null, version numeric(18,0), dicomattrs_fk numeric(18,0) not null, merge_fk numeric(18,0), patient_id_fk numeric(18,0), pat_name_fk numeric(18,0), resp_person_fk numeric(18,0), primary key (pk));
...
create table queue_msg (pk numeric(18,0) not null, batchID varchar(255), created_time timestamp not null, device_name varchar(255) not null, error_msg varchar(255), msg_body blob not null, msg_id varchar(255) not null, msg_props varchar(4000) not null, num_failures integer not null, outcome_msg varchar(255), priority integer not null, proc_end_time timestamp, proc_start_time timestamp, queue_name varchar(255) not null, scheduled_time timestamp not null, msg_status integer not null, updated_time timestamp not null, version numeric(18,0), primary key (pk));
...
create table series (pk numeric(18,0) not null, body_part varchar(255) not null, completeness integer not null, created_time timestamp not null, expiration_date varchar(255), ext_retrieve_aet varchar(255), failed_retrieves integer not null, inst_purge_state integer not null, inst_purge_time timestamp, institution varchar(255) not null, department varchar(255) not null, laterality varchar(255) not null, metadata_update_time timestamp, modality varchar(255) not null, pps_cuid varchar(255) not null, pps_iuid varchar(255) not null, pps_start_date varchar(255) not null, pps_start_time varchar(255) not null, rejection_state integer not null, series_custom1 varchar(255) not null, series_custom2 varchar(255) not null, series_custom3 varchar(255) not null, series_desc varchar(255) not null, series_iuid varchar(255) not null, series_no integer, series_size numeric(18,0) not null, sop_cuid varchar(255) not null, src_aet varchar(255), station_name varchar(255) not null, tsuid varchar(255) not null, updated_time timestamp not null, version numeric(18,0), dicomattrs_fk numeric(18,0) not null, inst_code_fk numeric(18,0), metadata_fk numeric(18,0), perf_phys_name_fk numeric(18,0), study_fk numeric(18,0) not null, primary key (pk));
