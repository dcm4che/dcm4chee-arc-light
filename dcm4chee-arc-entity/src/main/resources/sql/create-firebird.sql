...
create table queue_msg (pk numeric(18,0) not null, created_time timestamp not null, device_name varchar(255) not null, error_msg varchar(255), msg_body blob not null, msg_id varchar(255) not null, msg_props varchar(4000) not null, num_failures integer not null, outcome_msg varchar(255), priority integer not null, proc_end_time timestamp, proc_start_time timestamp, queue_name varchar(255) not null, scheduled_time timestamp not null, msg_status integer not null, updated_time timestamp not null, version numeric(18,0), primary key (pk));
