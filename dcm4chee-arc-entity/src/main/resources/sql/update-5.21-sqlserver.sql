...
alter table retrieve_task
    add scheduled_time datetime2;

alter table export_task alter column scheduled_time datetime2 not null;
...
update retrieve_task
    set scheduled_time = queue_msg.scheduled_time from queue_msg
