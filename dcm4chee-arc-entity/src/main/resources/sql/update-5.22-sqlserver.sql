...
alter table mwl_item
    alter column local_aet varchar not null;
alter table mwl_item
    alter column admission_id varchar not null;
alter table mwl_item
    alter column institution varchar not null;
alter table mwl_item
    alter column department varchar not null;
