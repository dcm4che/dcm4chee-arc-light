...
alter table study_query_attrs modify cuids_in_study varchar(4000);
...
alter table mwl_item
    modify local_aet varchar(255) not null;
alter table mwl_item
    modify admission_id varchar(255) not null;
alter table mwl_item
    modify column institution varchar(255) not null;
alter table mwl_item
    modify column department varchar(255) not null;

alter table study
    modify column admission_id varchar(255) not null;