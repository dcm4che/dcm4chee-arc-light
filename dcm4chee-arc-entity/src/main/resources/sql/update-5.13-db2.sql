...
create table diff_task (pk bigint generated by default as identity, check_different smallint not null, check_missing smallint not null, compare_fields varchar(255), created_time timestamp not null, different integer not null, local_aet varchar(255) not null, matches integer not null, missing integer not null, primary_aet varchar(255) not null, query_str varchar(255) not null, secondary_aet varchar(255) not null, updated_time timestamp not null, queue_msg_fk bigint not null, primary key (pk));
