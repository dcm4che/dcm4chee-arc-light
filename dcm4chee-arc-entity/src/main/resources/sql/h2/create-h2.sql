...
create table global_subscription (pk bigint generated by default as identity, deletion_lock boolean not null, subscriber_aet varchar(255) not null, matchkeys_fk bigint, primary key (pk));
