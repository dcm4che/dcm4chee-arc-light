create table code (pk bigint generated by default as identity, code_meaning varchar(255) not null, code_value varchar(255) not null, code_designator varchar(255) not null, code_version varchar(255) not null, primary key (pk), constraint UKsb4oc9lkns36wswku831c33w6 unique (code_value, code_designator, code_version));
...
create table global_subscription (pk bigint generated by default as identity, deletion_lock boolean not null, subscriber_aet varchar(255) not null, matchkeys_fk bigint unique, primary key (pk), constraint UK4n26cxir6d3tksb2cd1kd86ch unique (subscriber_aet));
...
create table ian_task (pk bigint generated by default as identity, calling_aet varchar(255) not null, device_name varchar(255) not null, ian_dests varchar(255) not null, scheduled_time timestamp(6), study_iuid varchar(255), mpps_fk bigint unique, primary key (pk), constraint UKdq88edcjjxh7h92f89y5ueast unique (study_iuid));
...
create table key_value2 (pk bigint generated by default as identity, content_type varchar(255) not null, created_time timestamp(6) not null, key_name varchar(255) not null, updated_time timestamp(6) not null, username varchar(255), key_value varchar(4000) not null, primary key (pk), constraint UK4gq7ksl296rsm6ap9hjrogv3g unique (key_name));
...
create table subscription (pk bigint generated by default as identity, deletion_lock boolean not null, subscriber_aet varchar(255) not null, ups_fk bigint not null, primary key (pk), constraint UKco8q5hn46dehb35qsrtwyys96 unique (subscriber_aet, ups_fk));
