create table code (pk bigint generated by default as identity, code_meaning varchar(255) not null, code_value varchar(255) not null, code_designator varchar(255) not null, code_version varchar(255) not null, primary key (pk), unique (code_value, code_designator, code_version));
...
create table dicomattrs (pk bigint generated by default as identity, attrs longblob not null, primary key (pk));
create table global_subscription (pk bigint generated by default as identity, deletion_lock boolean not null, subscriber_aet varchar(255) not null, matchkeys_fk bigint unique, primary key (pk), unique (subscriber_aet));
create table hl7psu_task (pk bigint generated by default as identity, accession_no varchar(255), aet varchar(255) not null, created_time timestamp(6) not null, device_name varchar(255) not null, pps_status tinyint check (pps_status between 0 and 2), scheduled_time timestamp(6), series_iuid varchar(255), study_iuid varchar(255), mpps_fk bigint unique, primary key (pk), unique (study_iuid, pps_status));
create table ian_task (pk bigint generated by default as identity, calling_aet varchar(255) not null, device_name varchar(255) not null, ian_dests varchar(255) not null, scheduled_time timestamp(6), study_iuid varchar(255), mpps_fk bigint unique, primary key (pk), unique (study_iuid));
...
create table key_value2 (pk bigint generated by default as identity, content_type varchar(255) not null, created_time timestamp(6) not null, key_name varchar(255) not null, updated_time timestamp(6) not null, username varchar(255), key_value varchar(4000) not null, primary key (pk), unique (key_name));
create table location (pk bigint generated by default as identity, created_time timestamp(6) not null, digest varchar(255), multi_ref integer, object_type tinyint not null check (object_type between 0 and 1), object_size bigint not null, status tinyint not null check (status between 0 and 17), storage_id varchar(255) not null, storage_path varchar(255) not null, tsuid varchar(255), uidmap_fk bigint, instance_fk bigint, primary key (pk));
create table metadata (pk bigint generated by default as identity, created_time timestamp(6) not null, digest varchar(255), object_size bigint not null, status tinyint not null check (status between 0 and 9), storage_id varchar(255) not null, storage_path varchar(255) not null, primary key (pk));
create table mpps (pk bigint generated by default as identity, accession_no varchar(255) not null, accno_entity_id varchar(255), accno_entity_uid varchar(255), accno_entity_uid_type varchar(255), created_time timestamp(6) not null, pps_start_date varchar(255) not null, pps_start_time varchar(255) not null, sop_iuid varchar(255) not null, pps_status tinyint not null check (pps_status between 0 and 2), study_iuid varchar(255) not null, updated_time timestamp(6) not null, version bigint, dicomattrs_fk bigint not null unique, discreason_code_fk bigint, patient_fk bigint not null, primary key (pk), unique (sop_iuid));
...
create table rejected_instance (pk bigint generated by default as identity, created_time timestamp(6) not null, series_iuid varchar(255) not null, sop_cuid varchar(255) not null, sop_iuid varchar(255) not null, study_iuid varchar(255) not null, reject_code_fk bigint, primary key (pk), unique (study_iuid, series_iuid, sop_iuid));
...
create table verify_observer (pk bigint generated by default as identity, verify_datetime varchar(255) not null, observer_name_fk bigint unique, instance_fk bigint, primary key (pk));
