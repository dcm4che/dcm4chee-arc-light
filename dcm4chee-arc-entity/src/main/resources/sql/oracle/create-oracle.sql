...
create table code (pk number(19,0) not null, code_meaning nvarchar2(255) not null, code_value varchar2(255 char) not null, code_designator varchar2(255 char) not null, code_version varchar2(255 char) not null, primary key (pk), unique (code_value, code_designator, code_version));
create table content_item (pk number(19,0) not null, rel_type varchar2(255 char) not null, text_value nvarchar2(255) not null, code_fk number(19,0), name_fk number(19,0) not null, instance_fk number(19,0), primary key (pk));
...
create table instance_req (pk number(19,0) not null, accession_no nvarchar2(255) not null, accno_entity_id varchar2(255 char), accno_entity_uid varchar2(255 char), accno_entity_uid_type varchar2(255 char), req_proc_id nvarchar2(255) not null, req_service nvarchar2(255) not null, sps_id nvarchar2(255) not null, study_iuid varchar2(255 char) not null, req_phys_name_fk number(19,0) unique, instance_fk number(19,0), primary key (pk));
...
create table mwl_item (pk number(19,0) not null, accession_no nvarchar2(255) not null, accno_entity_id varchar2(255 char), accno_entity_uid varchar2(255 char), accno_entity_uid_type varchar2(255 char), admission_id nvarchar2(255) not null, admid_entity_id varchar2(255 char), admid_entity_uid varchar2(255 char), admid_entity_uid_type varchar2(255 char), created_time timestamp(6) not null, institution nvarchar2(255) not null, department nvarchar2(255) not null, modality varchar2(255 char) not null, req_proc_id nvarchar2(255) not null, sps_id nvarchar2(255) not null, sps_start_date varchar2(255 char) not null, sps_start_time varchar2(255 char) not null, sps_status number(3,0) not null check (sps_status between 0 and 7), study_iuid varchar2(255 char) not null, updated_time timestamp(6) not null, version number(19,0), worklist_label varchar2(255 char) not null, dicomattrs_fk number(19,0) not null unique, inst_code_fk number(19,0), dept_code_fk number(19,0), patient_fk number(19,0) not null, perf_phys_name_fk number(19,0) unique, primary key (pk), unique (study_iuid, sps_id));
...
create table series_req (pk number(19,0) not null, accession_no nvarchar2(255) not null, accno_entity_id varchar2(255 char), accno_entity_uid varchar2(255 char), accno_entity_uid_type varchar2(255 char), req_proc_id nvarchar2(255) not null, req_service nvarchar2(255) not null, sps_id nvarchar2(255) not null, study_iuid varchar2(255 char) not null, req_phys_name_fk number(19,0) unique, series_fk number(19,0), primary key (pk));
