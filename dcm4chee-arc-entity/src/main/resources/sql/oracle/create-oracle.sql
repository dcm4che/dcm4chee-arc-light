...
create table patient_id (pk number(19,0) not null, pat_id varchar2(255 char) not null, pat_id_type_code varchar2(255 char), entity_id varchar2(255 char) not null, entity_uid varchar2(255 char) not null, entity_uid_type varchar2(255 char) not null, version number(19,0), patient_fk number(19,0) not null, primary key (pk), unique (pat_id, entity_id, entity_uid, entity_uid_type));
