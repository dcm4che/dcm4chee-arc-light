...
create table key_value (pk number(19,0) not null, content_type varchar2(255 char) not null, created_time timestamp not null, key varchar2(255 char) not null, updated_time timestamp not null, username varchar2(255 char), value varchar2(4000 char) not null, primary key (pk));
