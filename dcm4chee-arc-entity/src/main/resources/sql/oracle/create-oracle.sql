...
create table mwl_item (pk number(19,0) not null, accession_no varchar2(255 char) not null, accno_entity_id varchar2(255 char), accno_entity_uid varchar2(255 char), accno_entity_uid_type varchar2(255 char), admission_id varchar2(255 char) not null, admid_entity_id varchar2(255 char), admid_entity_uid varchar2(255 char), admid_entity_uid_type varchar2(255 char), created_time timestamp not null, institution varchar2(255 char) not null, department varchar2(255 char) not null, modality varchar2(255 char) not null, req_proc_id varchar2(255 char) not null, sps_id varchar2(255 char) not null, sps_start_date varchar2(255 char) not null, sps_start_time varchar2(255 char) not null, sps_status number(10,0) not null, study_iuid varchar2(255 char) not null, updated_time timestamp not null, version number(19,0), worklist_label varchar2(255 char) not null, dicomattrs_fk number(19,0) not null, inst_code_fk number(19,0), dept_code_fk number(19,0), patient_fk number(19,0) not null, perf_phys_name_fk number(19,0), primary key (pk));
