...
create table global_subscription (
    ...
    deletion_lock number(1,0) not null,
    subscriber_aet varchar2(255 char) not null,
    matchkeys_fk number(19,0),
    primary key (pk));

create table rel_ups_perf_code (
    ups_fk number(19,0) not null,
    perf_code_fk number(19,0) not null);
...
create table ups (
    pk number(19,0) not null,
    admission_id varchar2(255 char) not null,
    created_time timestamp not null,
    expected_end_date_time varchar2(255 char) not null,
    input_readiness_state number(10,0) not null,
    performer_aet varchar2(255 char),
    ups_state number(10,0) not null,
    replaced_iuid varchar2(255 char) not null,
    expiration_date_time varchar2(255 char) not null,
    start_date_time varchar2(255 char) not null,
    transaction_iuid varchar2(255 char),
    updated_time timestamp not null,
    ups_iuid varchar2(255 char) not null,
    ups_label varchar2(255 char) not null,
    ups_priority number(10,0) not null,
    version number(19,0),
    worklist_label varchar2(255 char) not null,
    dicomattrs_fk number(19,0) not null,
    admission_issuer_fk number(19,0),
    patient_fk number(19,0) not null,
    station_class_fk number(19,0),
    station_location_fk number(19,0),
    station_name_fk number(19,0),
    ups_code_fk number(19,0),
    primary key (pk));
...
create table ups_req (
    ...
    req_service varchar2(255 char) not null,
    study_iuid varchar2(255 char) not null,
    accno_issuer_fk number(19,0),
