...
create table patient_id (pk int8 not null, pat_id varchar(255) not null, pat_id_type_code varchar(255), entity_id varchar(255), entity_uid varchar(255), entity_uid_type varchar(255), version int8, patient_fk int8 not null, primary key (pk));
...
alter table patient_id add constraint FK_hba9466n4re9re8id3c8abmnv foreign key (patient_fk) references patient;
