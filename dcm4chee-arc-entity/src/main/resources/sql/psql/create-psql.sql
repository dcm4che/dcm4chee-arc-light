...
create table code (pk bigint not null, code_meaning varchar(255) not null, code_value varchar(255) not null, code_designator varchar(255) not null, code_version varchar(255) not null, primary key (pk), constraint UKsb4oc9lkns36wswku831c33w6 unique (code_value, code_designator, code_version));
...
create table global_subscription (pk bigint not null, deletion_lock boolean not null, subscriber_aet varchar(255) not null, matchkeys_fk bigint unique, primary key (pk), constraint UK4n26cxir6d3tksb2cd1kd86ch unique (subscriber_aet));
...
create table ian_task (pk bigint not null, calling_aet varchar(255) not null, device_name varchar(255) not null, ian_dests varchar(255) not null, scheduled_time timestamp(6), study_iuid varchar(255), mpps_fk bigint unique, primary key (pk), constraint UKdq88edcjjxh7h92f89y5ueast unique (study_iuid));
create table id_sequence (name varchar(255) not null, next_value integer not null, version bigint, primary key (name));
create table instance (pk bigint not null, availability smallint not null check (availability between 0 and 3), sr_complete varchar(255) not null, content_date varchar(255) not null, content_time varchar(255) not null, created_time timestamp(6) not null, ext_retrieve_aet varchar(255), inst_custom1 varchar(255) not null, inst_custom2 varchar(255) not null, inst_custom3 varchar(255) not null, inst_no integer, num_frames integer, retrieve_aets varchar(255), sop_cuid varchar(255) not null, sop_iuid varchar(255) not null, updated_time timestamp(6) not null, sr_verified varchar(255) not null, version bigint, dicomattrs_fk bigint not null unique, srcode_fk bigint, series_fk bigint not null, primary key (pk), constraint UK247lgirehl8i2vuanyfjnuyjb unique (series_fk, sop_iuid));
...
create table key_value2 (pk bigint not null, content_type varchar(255) not null, created_time timestamp(6) not null, key_name varchar(255) not null, updated_time timestamp(6) not null, username varchar(255), key_value varchar(4000) not null, primary key (pk), constraint UK4gq7ksl296rsm6ap9hjrogv3g unique (key_name));
...
create table rejected_instance (pk bigint not null, created_time timestamp(6) not null, series_iuid varchar(255) not null, sop_cuid varchar(255) not null, sop_iuid varchar(255) not null, study_iuid varchar(255) not null, reject_code_fk bigint, primary key (pk), constraint UK6liqevdmi0spifxf2vrh18wkp unique (study_iuid, series_iuid, sop_iuid));
...
create table series (pk bigint not null, body_part varchar(255) not null, completeness smallint not null check (completeness between 0 and 2), compress_failures integer not null, compress_params varchar(255), compress_time timestamp(6), compress_tsuid varchar(255), created_time timestamp(6) not null, expiration_date varchar(255), expiration_exporter_id varchar(255), expiration_state smallint not null check (expiration_state between 0 and 5), ext_retrieve_aet varchar(255), failed_retrieves integer not null, stgver_failures integer not null, inst_purge_state smallint not null check (inst_purge_state between 0 and 2), inst_purge_time timestamp(6), institution varchar(255) not null, department varchar(255) not null, laterality varchar(255) not null, metadata_update_time timestamp(6), metadata_update_failures integer not null, modality varchar(255) not null, modified_time timestamp(6) not null, pps_cuid varchar(255) not null, pps_iuid varchar(255) not null, pps_start_date varchar(255) not null, pps_start_time varchar(255) not null, receiving_aet varchar(255), receiving_hl7_app varchar(255), receiving_hl7_facility varchar(255), receiving_pres_addr varchar(255), rejection_state smallint not null check (rejection_state between 0 and 3), sending_aet varchar(255), sending_hl7_app varchar(255), sending_hl7_facility varchar(255), sending_pres_addr varchar(255), series_custom1 varchar(255) not null, series_custom2 varchar(255) not null, series_custom3 varchar(255) not null, series_desc varchar(255) not null, series_iuid varchar(255) not null, series_no integer, series_size bigint not null, sop_cuid varchar(255) not null, station_name varchar(255) not null, stgver_time timestamp(6), tsuid varchar(255) not null, updated_time timestamp(6) not null, version bigint, dicomattrs_fk bigint not null unique, inst_code_fk bigint, dept_code_fk bigint, metadata_fk bigint unique, perf_phys_name_fk bigint unique, study_fk bigint not null, primary key (pk), constraint UK83y2fx8cou17h3xggxspgikna unique (study_fk, series_iuid));
create table series_query_attrs (pk bigint not null, availability smallint check (availability between 0 and 3), num_instances integer, retrieve_aets varchar(255), cuids_in_series varchar(255), view_id varchar(255), series_fk bigint not null, primary key (pk), constraint UKt1uhb1suiiqffhsv9eaopeevs unique (view_id, series_fk));
