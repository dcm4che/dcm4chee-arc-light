...
create table hl7psu_task (pk bigint not null auto_increment, accession_no varchar(255), aet varchar(255) not null, created_time datetime not null, device_name varchar(255) not null, pps_status integer, scheduled_time datetime, series_iuid varchar(255), study_iuid varchar(255), mpps_fk bigint, primary key (pk));
...
create table key_value (pk bigint not null auto_increment, content_type varchar(255) not null, created_time datetime not null, key varchar(255) not null, updated_time datetime not null, user varchar(255), value varchar(4000) not null, primary key (pk));
create table location (pk bigint not null auto_increment, created_time datetime not null, digest varchar(255), multi_ref integer, object_type integer not null, object_size bigint not null, status integer not null, storage_id varchar(255) not null, storage_path varchar(255) not null, tsuid varchar(255), uidmap_fk bigint, instance_fk bigint, primary key (pk));
...
create table mwl_item (pk bigint not null auto_increment, accession_no varchar(255) not null, accno_entity_id varchar(255), accno_entity_uid varchar(255), accno_entity_uid_type varchar(255), admission_id varchar(255) not null, admid_entity_id varchar(255), admid_entity_uid varchar(255), admid_entity_uid_type varchar(255), created_time datetime not null, institution varchar(255) not null, department varchar(255) not null, local_aet varchar(255) not null, modality varchar(255) not null, req_proc_id varchar(255) not null, sps_id varchar(255) not null, sps_start_date varchar(255) not null, sps_start_time varchar(255) not null, sps_status integer not null, study_iuid varchar(255) not null, updated_time datetime not null, version bigint, dicomattrs_fk bigint not null, inst_code_fk bigint, dept_code_fk bigint, patient_fk bigint not null, perf_phys_name_fk bigint, primary key (pk));
...
create table patient_id (pk bigint not null auto_increment, pat_id varchar(255) not null, pat_id_type_code varchar(255), entity_id varchar(255), entity_uid varchar(255), entity_uid_type varchar(255), version bigint, primary key (pk));
...
create index UK_apy4vqmy3asbet0nmqhag6lgt on key_value (user(64));
...
alter table instance_req add constraint FK_cqmmps9maltjybl44t4cck404 foreign key (req_phys_name_fk) references person_name (pk);
alter table instance_req add constraint FK_47n586hkafgp9m1etqohgfybl foreign key (instance_fk) references instance (pk);
