...
create table key_value (pk bigint not null auto_increment, content_type varchar(255) not null, created_time datetime not null, key varchar(255) not null, updated_time datetime not null, user varchar(255) not null, value varchar(4000) not null, primary key (pk));
