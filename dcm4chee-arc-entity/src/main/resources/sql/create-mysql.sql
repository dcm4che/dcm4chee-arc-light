...
create table retrieve_task (pk bigint not null auto_increment, batch_id varchar(255), completed integer not null, created_time datetime not null, destination_aet varchar(255) not null, device_name varchar(255) not null, error_comment varchar(255), failed integer not null, local_aet varchar(255) not null, queue_name varchar(255) not null, remaining integer not null, remote_aet varchar(255) not null, scheduled_time datetime not null, series_iuid varchar(255), sop_iuid varchar(255), status_code integer not null, study_iuid varchar(255) not null, updated_time datetime not null, warning integer not null, queue_msg_fk bigint, primary key (pk));
