...
alter table series_access_control_id drop foreign key if exists FKt7uu3btv6pro4wuxspq0pom8y;
...
alter table study_access_control_id drop foreign key if exists FKluah7q5kdwqidu6uwlrsndd7k;
