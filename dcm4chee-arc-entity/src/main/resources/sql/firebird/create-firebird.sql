...
create table code (pk bigint not null, code_meaning varchar(255) not null, code_value varchar(16) not null, code_designator varchar(16) not null, code_version varchar(16) not null, primary key (pk));
...
create table dicomattrs (pk bigint not null, attrs blob not null, primary key (pk));
create table global_subscription (pk bigint not null, deletion_lock smallint not null, subscriber_aet varchar(255) not null, matchkeys_fk bigint, primary key (pk));
create table hl7psu_task (pk bigint not null, accession_no varchar(255), aet varchar(255) not null, created_time timestamp not null, device_name varchar(255) not null, pps_status smallint check (pps_status between 0 and 2), scheduled_time timestamp, series_iuid varchar(255), study_iuid varchar(255), mpps_fk bigint, primary key (pk));
create table ian_task (pk bigint not null, calling_aet varchar(255) not null, device_name varchar(255) not null, ian_dests varchar(255) not null, scheduled_time timestamp, study_iuid varchar(255), mpps_fk bigint, primary key (pk));
create table id_sequence (name varchar(255) not null, next_value integer not null, version bigint, primary key (name));
create table instance (pk bigint not null, availability smallint not null check (availability between 0 and 3), sr_complete varchar(255) not null, content_date varchar(255) not null, content_time varchar(255) not null, created_time timestamp not null, ext_retrieve_aet varchar(255) not null, inst_custom1 varchar(255) not null, inst_custom2 varchar(255) not null, inst_custom3 varchar(255) not null, inst_no integer, num_frames integer, retrieve_aets varchar(255), sop_cuid varchar(255) not null, sop_iuid varchar(255) not null, updated_time timestamp not null, sr_verified varchar(255) not null, version bigint, dicomattrs_fk bigint not null, srcode_fk bigint, series_fk bigint not null, primary key (pk));
...
create table key_value2 (pk bigint not null, content_type varchar(255) not null, created_time timestamp not null, key_name varchar(255) not null, updated_time timestamp not null, username varchar(255), key_value varchar(4000) not null, primary key (pk));
create table location (pk bigint not null, created_time timestamp not null, digest varchar(255), multi_ref integer, object_type smallint not null check (object_type between 0 and 1), object_size bigint not null, status smallint not null check (status between 0 and 17), storage_id varchar(255) not null, storage_path varchar(255) not null, tsuid varchar(255), uidmap_fk bigint, instance_fk bigint, primary key (pk));
create table metadata (pk bigint not null, created_time timestamp not null, digest varchar(255), object_size bigint not null, status smallint not null check (status between 0 and 9), storage_id varchar(255) not null, storage_path varchar(255) not null, primary key (pk));
create table mpps (pk bigint not null, accession_no varchar(255) not null, accno_entity_id varchar(255), accno_entity_uid varchar(255), accno_entity_uid_type varchar(255), created_time timestamp not null, pps_start_date varchar(255) not null, pps_start_time varchar(255) not null, sop_iuid varchar(255) not null, pps_status smallint not null check (pps_status between 0 and 2), study_iuid varchar(255) not null, updated_time timestamp not null, version bigint, dicomattrs_fk bigint not null, discreason_code_fk bigint, patient_fk bigint not null, primary key (pk));
...
create table patient_id (pk bigint not null, pat_id varchar(64) not null, pat_id_type_code varchar(64), entity_id varchar(64) not null, pat_name varchar(64) not null, entity_uid varchar(64) not null, entity_uid_type varchar(64) not null, version bigint, patient_fk bigint not null, primary key (pk));
...
create table series (pk bigint not null, access_control_id varchar(255), body_part varchar(255) not null, completeness smallint not null check (completeness between 0 and 2), compress_failures integer not null, compress_params varchar(255), compress_time timestamp, compress_tsuid varchar(255), created_time timestamp not null, expiration_date varchar(255), expiration_exporter_id varchar(255), expiration_state smallint not null check (expiration_state between 0 and 5), ext_retrieve_aet varchar(255) not null, failed_retrieves integer not null, stgver_failures integer not null, inst_purge_state smallint not null check (inst_purge_state between 0 and 2), inst_purge_time timestamp, institution varchar(255) not null, department varchar(255) not null, laterality varchar(255) not null, metadata_update_time timestamp, metadata_update_failures integer not null, metadata_update_load_objects smallint not null, modality varchar(255) not null, modified_time timestamp not null, num_instances integer, pps_cuid varchar(255) not null, pps_iuid varchar(255) not null, pps_start_date varchar(255) not null, pps_start_time varchar(255) not null, receiving_aet varchar(255), receiving_hl7_app varchar(255), receiving_hl7_facility varchar(255), receiving_pres_addr varchar(255), rejection_state smallint not null check (rejection_state between 0 and 3), sending_aet varchar(255), sending_hl7_app varchar(255), sending_hl7_facility varchar(255), sending_pres_addr varchar(255), series_custom1 varchar(255) not null, series_custom2 varchar(255) not null, series_custom3 varchar(255) not null, series_desc varchar(255) not null, series_iuid varchar(255) not null, series_no integer, series_size bigint not null, sop_cuid varchar(255) not null, station_name varchar(255) not null, stgver_time timestamp, tsuid varchar(255) not null, updated_time timestamp not null, version bigint, dicomattrs_fk bigint not null, inst_code_fk bigint, dept_code_fk bigint, metadata_fk bigint, perf_phys_name_fk bigint, study_fk bigint not null, primary key (pk));
create table series_access_control_id (series_fk bigint not null, access_control_id varchar(255));
create table series_query_attrs (pk bigint not null, availability smallint check (availability between 0 and 3), num_instances integer, retrieve_aets varchar(255), cuids_in_series varchar(255), view_id varchar(255), series_fk bigint not null, primary key (pk));
...
create table stgcmt_result (pk bigint not null, batch_id varchar(255), created_time timestamp not null, device_name varchar(255) not null, exporter_id varchar(255), num_failures integer, num_instances integer, series_iuid varchar(255), sop_iuid varchar(255), stgcmt_status smallint not null check (stgcmt_status between 0 and 3), study_iuid varchar(255) not null, task_fk bigint, transaction_uid varchar(255) not null, updated_time timestamp not null, primary key (pk));
create table study (pk bigint not null, access_control_id varchar(255), access_time timestamp not null, accession_no varchar(255) not null, accno_entity_id varchar(255), accno_entity_uid varchar(255), accno_entity_uid_type varchar(255), admission_id varchar(255) not null, admid_entity_id varchar(255), admid_entity_uid varchar(255), admid_entity_uid_type varchar(255), completeness smallint not null check (completeness between 0 and 2), created_time timestamp not null, study_deleting smallint not null, expiration_date varchar(255), expiration_exporter_id varchar(255), expiration_state smallint not null check (expiration_state between 0 and 5), ext_retrieve_aet varchar(255) not null, failed_retrieves integer not null, modified_time timestamp not null, rejection_state smallint not null check (rejection_state between 0 and 3), study_size bigint not null, storage_ids varchar(255), study_custom1 varchar(255) not null, study_custom2 varchar(255) not null, study_custom3 varchar(255) not null, study_date varchar(255) not null, study_desc varchar(255) not null, study_id varchar(255) not null, study_iuid varchar(255) not null, study_time varchar(255) not null, updated_time timestamp not null, version bigint, dicomattrs_fk bigint not null, patient_fk bigint not null, ref_phys_name_fk bigint, primary key (pk));
create table study_access_control_id (study_fk bigint not null, access_control_id varchar(255));
create table study_query_attrs (pk bigint not null, availability smallint check (availability between 0 and 3), mods_in_study varchar(255), num_instances integer, num_series integer, retrieve_aets varchar(255), cuids_in_study varchar(4000), view_id varchar(255), study_fk bigint not null, primary key (pk));
create table subscription (pk bigint not null, deletion_lock smallint not null, subscriber_aet varchar(255) not null, ups_fk bigint not null, primary key (pk));
...
create table verify_observer (pk bigint not null, verify_datetime varchar(255) not null, observer_name_fk bigint, instance_fk bigint, primary key (pk));
...
alter table global_subscription add constraint UKf1l196ykcnh7s2pwo6qnmltw7 unique (matchkeys_fk);
...
alter table hl7psu_task add constraint UKpev4urgkk7id2h1ijhv8domjx unique (mpps_fk);
...
alter table ian_task add constraint UK1fuh251le2hid2byw90hd1mly unique (mpps_fk);
...
alter table instance_req add constraint UKcqmmps9maltjybl44t4cck404 unique (req_phys_name_fk);
...
alter table mwl_item add constraint UK44qwwvs50lgpog2cqmicxgt1f unique (perf_phys_name_fk);
...
alter table patient add constraint UKrj42ffdtimnrcwmqqlvj24gi2 unique (pat_name_fk);
alter table patient add constraint UK56r2g5ggptqgcvb3hl11adke2 unique (resp_person_fk);
...
alter table series add constraint UKpu4p7k1o9hleuk9rmxvw2ybj6 unique (metadata_fk);
alter table series add constraint UK5n4bxxb2xa7bvvq26ao7wihky unique (perf_phys_name_fk);
...
alter table series_req add constraint UKbcn0jtvurqutw865pwp34pejb unique (req_phys_name_fk);
...
alter table study add constraint UK49eet5qgcsb32ktsqrf1mj3x2 unique (ref_phys_name_fk);
...
alter table ups_req add constraint UKkocdb2pxx2fymu1modhneb4xm unique (req_phys_name_fk);
create index IDX5btv5autls384ulwues8lym4p on verify_observer (verify_datetime);
alter table verify_observer add constraint UK105wt9hglqsmtnoxgma9x18vj unique (observer_name_fk);
