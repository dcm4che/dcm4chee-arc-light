...
create table patient_id (pk bigint not null, pat_id varchar(64) not null, pat_id_type_code varchar(64), entity_id varchar(64), entity_uid varchar(64), entity_uid_type varchar(64), version bigint, patient_fk bigint not null, primary key (pk));
