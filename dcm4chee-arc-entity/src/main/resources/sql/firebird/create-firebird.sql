...
create table hl7psu_task (pk numeric(18,0) not null, accession_no varchar(255), aet varchar(255) not null, created_time timestamp not null, device_name varchar(255) not null, pps_status integer, scheduled_time timestamp, series_iuid varchar(255), study_iuid varchar(255), mpps_fk numeric(18,0), primary key (pk));
...
create table key_value2 (pk numeric(18,0) not null, content_type varchar(255) not null, created_time timestamp not null, key_name varchar(255) not null, updated_time timestamp not null, username varchar(255), key_value varchar(4000) not null, primary key (pk));
...
create table series_req (pk numeric(18,0) not null, accession_no varchar(255) not null, accno_entity_id varchar(255), accno_entity_uid varchar(255), accno_entity_uid_type varchar(255), req_proc_id varchar(255) not null, req_service varchar(255) not null, sps_id varchar(255) not null, study_iuid varchar(255) not null, req_phys_name_fk numeric(18,0), series_fk numeric(18,0), primary key (pk));
...
create table stgcmt_result (pk numeric(18,0) not null, batch_id varchar(255), created_time timestamp not null, device_name varchar(255) not null, exporter_id varchar(255), num_failures integer, num_instances integer, series_iuid varchar(255), sop_iuid varchar(255), stgcmt_status integer not null, study_iuid varchar(255) not null, task_fk numeric(18,0), transaction_uid varchar(255) not null, updated_time timestamp not null, primary key (pk));
create table study (pk numeric(18,0) not null, access_control_id varchar(255) not null, access_time timestamp not null, accession_no varchar(255) not null, accno_entity_id varchar(255), accno_entity_uid varchar(255), accno_entity_uid_type varchar(255), admission_id varchar(255) not null, admid_entity_id varchar(255), admid_entity_uid varchar(255), admid_entity_uid_type varchar(255), completeness integer not null, created_time timestamp not null, expiration_date varchar(255), expiration_exporter_id varchar(255), expiration_state integer not null, ext_retrieve_aet varchar(255) not null, failed_retrieves integer not null, modified_time timestamp not null, rejection_state integer not null, study_size numeric(18,0) not null, storage_ids varchar(255), study_custom1 varchar(255) not null, study_custom2 varchar(255) not null, study_custom3 varchar(255) not null, study_date varchar(255) not null, study_desc varchar(255) not null, study_id varchar(255) not null, study_iuid varchar(255) not null, study_time varchar(255) not null, updated_time timestamp not null, version numeric(18,0), dicomattrs_fk numeric(18,0) not null, patient_fk numeric(18,0) not null, ref_phys_name_fk numeric(18,0), primary key (pk));
create table study_query_attrs (pk numeric(18,0) not null, availability integer, mods_in_study varchar(255), num_instances integer, num_series integer, retrieve_aets varchar(255), cuids_in_study varchar(4000), view_id varchar(255), study_fk numeric(18,0) not null, primary key (pk));
