...
WHERE RDB$CONSTRAINT_NAME = 'FKLUAH7Q5KDWQIDU6UWLRSNDD7K';
...
SELECT COUNT(*)
FROM RDB$RELATION_CONSTRAINTS
WHERE RDB$CONSTRAINT_NAME = 'FKt7uu3btv6pro4wuxspq0pom8y';
--if returns 0, execute next
...
-- don't execute below, else throws already exists
