...
create table rel_ups_station_class_code (ups_fk numeric(18,0) not null, station_class_code_fk numeric(18,0) not null);
create table rel_ups_station_location_code (ups_fk numeric(18,0) not null, station_location_code_fk numeric(18,0) not null);
create table rel_ups_station_name_code (ups_fk numeric(18,0) not null, station_name_code_fk numeric(18,0) not null);
...
alter table mpps drop accno_issuer_fk;
alter table mwl_item drop accno_issuer_fk, drop admid_issuer_fk;
alter table patient_id drop constraint UK_31gvi9falc03xs94m8l3pgoid;
alter table patient_id drop issuer_fk;
alter table series_req drop accno_issuer_fk;
alter table study drop accno_issuer_fk, drop admid_issuer_fk;
alter table ups drop admission_issuer_fk, drop station_name_fk, drop station_class_fk, drop station_location_fk;
alter table ups_req drop accno_issuer_fk;
drop table issuer;
drop generator issuer_pk_seq;