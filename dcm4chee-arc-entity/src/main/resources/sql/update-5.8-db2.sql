...
create table metadata (pk bigint generated by default as identity, digest varchar(255), object_size bigint not null, status integer not null, storage_id varchar(255) not null, storage_path varchar(255) not null, primary key (pk));

alter table series add metadata_update_time timestamp, add metadata_fk bigint, add inst_purge_time timestamp, add inst_purge_state integer;
