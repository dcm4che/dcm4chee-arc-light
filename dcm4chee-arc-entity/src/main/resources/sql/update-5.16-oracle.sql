...
alter table study add expiration_state number(10,0);
alter table study add expiration_exporter_id varchar2(255);

alter table series add expiration_state number(10,0);
alter table series add expiration_exporter_id varchar2(255);
...
alter table study modify expiration_state not null;
alter table series modify expiration_state not null;
