...
alter table study add expiration_state int;
alter table study add expiration_exporter_id varchar(255);

alter table series add expiration_state int;
...
alter table study alter column expiration_state int not null;
alter table series alter column expiration_state int not null;
