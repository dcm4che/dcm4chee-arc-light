alter table queue_msg alter msg_props varchar(4000) not null;   --uncertain
alter table location alter object_size bigint not null, alter storage_id varchar(255) not null, alter storage_path varchar(255) not null, alter tsuid varchar(255) not null;
...
alter table code alter code_version varchar(255) not null;
...
alter table study alter storage_ids varchar(255) not null;
...
alter table series alter rejection_state integer not null;
...
alter table study alter rejection_state integer not null;
