...
create table stgver_task (pk numeric(18,0) not null, completed integer not null, created_time timestamp not null,
  failed integer not null, local_aet varchar(255) not null, series_iuid varchar(255), sop_iuid varchar(255),
  storage_ids varchar(255), stgcmt_policy integer, study_iuid varchar(255) not null, update_location_status smallint,
...
create index UK_iudr0qmrm15i2evq1733h1ace on stgver_task (study_iuid(64), series_iuid(64), sop_iuid(64)); -- throws error token unknown
