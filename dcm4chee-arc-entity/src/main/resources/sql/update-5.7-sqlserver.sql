...
alter table instance add ext_retrieve_aet varchar(255), add num_frames int;
...
create table stgcmt_result (pk bigint identity not null, created_time datetime2 not null, device_name varchar(255) not null, exporter_id varchar(255) not null, num_failures int, num_instances int, series_iuid varchar(255), sop_iuid varchar(255), stgcmt_status int not null, study_iuid varchar(255) not null, transaction_uid varchar(255) not null, updated_time datetime2 not null, primary key (pk));
