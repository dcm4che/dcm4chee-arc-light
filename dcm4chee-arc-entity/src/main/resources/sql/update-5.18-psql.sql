...
create table rejected_instance (
   pk int8 default nextval('rejected_instance_pk_seq') not null,
...
insert into rejected_instance (created_time, sop_cuid, sop_iuid, reject_code_fk, series_iuid, study_iuid)
    (select i.updated_time, i.sop_cuid, i.sop_iuid, i.reject_code_fk, se.series_iuid, st.study_iuid from instance i
