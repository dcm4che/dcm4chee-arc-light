...
alter table retrieve_task alter queue_msg_fk set not null;
alter table stgcmt_result alter exporter_id set not null;
...
alter table retrieve_task alter device_name set not null;
alter table retrieve_task alter queue_name set not null;
