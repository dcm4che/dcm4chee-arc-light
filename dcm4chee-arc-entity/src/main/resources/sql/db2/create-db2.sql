...
create table key_value (pk bigint generated by default as identity, content_type varchar(255) not null, created_time timestamp not null, key varchar(255) not null, updated_time timestamp not null, username varchar(255), value varchar(4000) not null, primary key (pk));
...
create unique index UK_gvyp924rq0a5y8u3emjs35g2q on key_value (key);
