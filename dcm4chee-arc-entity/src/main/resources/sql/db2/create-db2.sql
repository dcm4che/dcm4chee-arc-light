...
create table key_value2 (pk bigint generated by default as identity, content_type varchar(255) not null, created_time timestamp not null, key_name varchar(255) not null, updated_time timestamp not null, username varchar(255), key_value varchar(4000) not null, primary key (pk));
...
create table rejected_instance (pk bigint generated by default as identity, created_time timestamp not null, series_iuid varchar(255) not null, sop_cuid varchar(255) not null, sop_iuid varchar(255) not null, study_iuid varchar(255) not null, reject_code_fk bigint, primary key (pk));
...
create table soundex_code (pk bigint generated by default as identity, sx_code_value varchar(255) not null, sx_pn_comp_part integer not null, sx_pn_comp integer not null, person_name_fk bigint not null, primary key (pk));
create table sps_station_aet (mwl_item_fk bigint not null, station_aet varchar(255));
create table stgcmt_result (pk bigint generated by default as identity, batch_id varchar(255), created_time timestamp not null, device_name varchar(255) not null, exporter_id varchar(255), num_failures integer, num_instances integer, series_iuid varchar(255), sop_iuid varchar(255), stgcmt_status integer not null, study_iuid varchar(255) not null, task_fk bigint, transaction_uid varchar(255) not null, updated_time timestamp not null, primary key (pk));
create table study (pk bigint generated by default as identity, access_control_id varchar(255) not null, access_time timestamp not null, accession_no varchar(255) not null, accno_entity_id varchar(255), accno_entity_uid varchar(255), accno_entity_uid_type varchar(255), admission_id varchar(255) not null, admid_entity_id varchar(255), admid_entity_uid varchar(255), admid_entity_uid_type varchar(255), completeness integer not null, created_time timestamp not null, expiration_date varchar(255), expiration_exporter_id varchar(255), expiration_state integer not null, ext_retrieve_aet varchar(255) not null, failed_retrieves integer not null, modified_time timestamp not null, rejection_state integer not null, study_size bigint not null, storage_ids varchar(255), study_custom1 varchar(255) not null, study_custom2 varchar(255) not null, study_custom3 varchar(255) not null, study_date varchar(255) not null, study_desc varchar(255) not null, study_id varchar(255) not null, study_iuid varchar(255) not null, study_time varchar(255) not null, updated_time timestamp not null, version bigint, dicomattrs_fk bigint not null, patient_fk bigint not null, ref_phys_name_fk bigint, primary key (pk));
create table study_query_attrs (pk bigint generated by default as identity, availability integer, mods_in_study varchar(255), num_instances integer, num_series integer, retrieve_aets varchar(255), cuids_in_study varchar(4000), view_id varchar(255), study_fk bigint not null, primary key (pk));
...
create unique index UK_sb4oc9lkns36wswku831c33w6 on code (code_value, code_designator, code_version);
...
create unique index UK_4n26cxir6d3tksb2cd1kd86ch on global_subscription (subscriber_aet);
...
create unique index UK_dq88edcjjxh7h92f89y5ueast on ian_task (study_iuid);
...
create unique index UK_247lgirehl8i2vuanyfjnuyjb on instance (series_fk, sop_iuid);
...
create unique index UK_cyqglxijg7kebbj6oj821yx4d on mpps (sop_iuid);
...
create unique index UK_39gahcxyursxfxe2ucextr65s on patient (patient_id_fk);
...
create unique index UK_6liqevdmi0spifxf2vrh18wkp on rejected_instance (study_iuid, series_iuid, sop_iuid);
...
create unique index UK_83y2fx8cou17h3xggxspgikna on series (study_fk, series_iuid);
...
create unique index UK_t1uhb1suiiqffhsv9eaopeevs on series_query_attrs (view_id, series_fk);
...
create unique index UK_ey6qpep2qtiwayou7pd0vj22w on stgcmt_result (transaction_uid);
...
create unique index UK_pt5qn20x278wb1f7p2t3lcxv on study (study_iuid);
...
create unique index UK_prn4qt6d42stw0gfi1yce1fap on study_query_attrs (view_id, study_fk);
create unique index UK_co8q5hn46dehb35qsrtwyys96 on subscription (subscriber_aet, ups_fk);
...
create unique index UK_qck03rlxht9myv77sc79a480t on ups (ups_iuid);
