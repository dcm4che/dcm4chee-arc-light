alter table queue_msg alter msg_props set data type varchar(4000);
...
--doesn't work-start--
alter table code drop constraint UK_l01jou0o1rohy7a9p933ndrxg;    --doesn't work
...
update study set storage_ids = (
  select listagg(distinct (storage_id), '\')
  from location
...
create index UK_fypbtohf5skbd3bkyd792a6dt on study (storage_ids);   --doesn't work
...
create index UK_jlgy9ifvqak4g2bxkchismw8x on series (rejection_state);    --doesn't work
...
create index UK_hwu9omd369ju3nufufxd3vof2 on study (rejection_state);   --doesn't work