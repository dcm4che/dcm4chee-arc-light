...
alter table series alter series_no set not null;

alter table instance add ext_retrieve_aet varchar(255) add num_frames integer;
alter table instance alter inst_no set not null;
...
create table stgcmt_result (pk bigint generated by default as identity, created_time timestamp not null, device_name varchar(255) not null, exporter_id varchar(255) not null, num_failures integer, num_instances integer, series_iuid varchar(255), sop_iuid varchar(255), stgcmt_status integer not null, study_iuid varchar(255) not null, transaction_uid varchar(255) not null, updated_time timestamp not null, primary key (pk));
