...
alter table mwl_item add local_aet varchar(255);
alter table mwl_item add admission_id varchar(255);
alter table mwl_item add institution varchar(255);
alter table mwl_item add department varchar(255);
alter table mwl_item add inst_code_fk bigint;
alter table mwl_item add dept_code_fk bigint;
alter table mwl_item add admid_issuer_fk bigint;

alter table series add dept_code_fk bigint;
