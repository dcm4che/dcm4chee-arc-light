...
@NamedQuery(
    name = Instance.FIND_WITHOUT_LOCATIONS_BY_STUDY_PK,
    query = "select i from Instance i " +
            "where i.series.study.pk = ?1 and i.locations is empty"),
@NamedQuery(
...
public class Instance {
    ...
    public static final String FIND_WITHOUT_LOCATIONS_BY_STUDY_PK = "Instance.findWithoutLocationsByStudyPK";
