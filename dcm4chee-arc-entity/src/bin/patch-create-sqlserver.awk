...
BEGIN { FS = "[ )]" }
{
    if ($6 == "UK_gknfxd1vh283cmbg8ymia9ms8") {
            print "create unique index UK_gknfxd1vh283cmbg8ymia9ms8 on issuer(entity_id) where entity_id is not null"
    } else if ($6 == "UK_t1p7jajas0mu12sx8jvtp2y0f") {
